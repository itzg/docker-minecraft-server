...
With [lazymc-docker-proxy](https://github.com/joesturge/lazymc-docker-proxy/settings) you are able to use [lazymc](https://github.com/timvisee/lazymc) with the minecraft container.
